          ...
          <div class="row gy-5">
              ...
              <div class="col-xl-4 col-md-6">
                <div class="post-item position-relative h-100">
                  ...
                  <div class="post-img position-relative overflow-hidden">
                    @if($blog->cover_image)
                      <img src="{{ asset('storage/' . $blog->cover_image) }}" class="img-fluid" alt="Blog Cover">
                    @else
                      <img src="{{ asset('assets/img/default-blog.jpg') }}" class="img-fluid" alt="Default Cover">
                    @endif
                    <span class="post-date">{{ \Carbon\Carbon::parse($blog->created_at)->format('F d') }}</span>
                  </div>
      
                  <div class="post-content d-flex flex-column">
                    <h3 class="post-title">{{ Str::limit($blog->title, 60) }}</h3>
            ...
            @empty
              <div class="col-12 text-center">
                <p class="text-muted fs-5">No Blog Posts Yet!</p>
              </div>
            @endforelse
          </div>
        </div>
